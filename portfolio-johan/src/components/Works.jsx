      ...
      <section id="works" className="py-20 px-10 bg-white border-y-3 border-black">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={closeModal}>
            ...
            >
              <button onClick={closeModal} className="absolute top-4 right-4 text-3xl font-black group-hover:grayscale-0 transition-colors cursor-pointer">✕</button>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                <h4 className="font-black uppercase text-md bg-black text-black px-2 inline-block italic bg-brand-yellow border-2 border-black">
                  Tecnologias
                </h4>
