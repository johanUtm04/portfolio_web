const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 flex justify-between items-center p-2 bg-brand-bg border-b-3 border-black shadow-sm">
      ...
      <ul className="hidden md:flex gap-8 font-bold text-lg">
        <li className="group">
          <a href="#home" className="group-hover:text-brand-accent transition-colors">Home</a>
        ...
        <li className="group">
          <a href="#stack" className="group-hover:text-brand-accent transition-colors">Tech Stack</a>
          <div className="h-1 bg-brand-accent scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
        </li>
        ...
        <li>
          <a 
            href="#contact" className="bg-brand-accent text-white px-4 py-2 border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
            Contact
          </a>
        </li>
      </ul>
