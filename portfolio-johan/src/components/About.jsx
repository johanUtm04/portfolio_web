      ...
      <div className="flex-[1.5]">
        ...
        <div className="space-y-4 text-lg font-medium leading-relaxed">
          <p>
            ...
            Con una Ingenieria en gestión y creacion de Software con experiencia práctica en el ciclo completo de desarrollo (Full-Stack).
          </p>
          ...
          <p>
            ...
            Mi enfoque principal es optimizar procesos de negocio mediante software moderno, como lo hice al digitalizar la gestión de formatos veterinarios para <span className="text-brand-accent font-bold">
            IMPA (Instituto Municipal de Protección Anima)</span>.
          </p>

          <p>
            Cuento con experiencia reparando errores críticos en sistemas legacy y optimizando bases de datos <span className="font-bold">MySQL</span> en entornos del sector médico. 
